...
public class MongoDBJournalV2 implements JournalStorage {
    ...
    public void saveEvent(Event event) {
        DBCollection collection = db.getCollection(event.getAggregateRootId());
    ...
    public void saveEvents(List<Event> events) {
        ...
        String agg = events.get(0).getAggregateRootId();
	...
	@Override
	public EventBatch loadEventsForAggregateId(String aggregateType,
			String aggregateId, String fromJournalId) {
		return null;
	}
}
